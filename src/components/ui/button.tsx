  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-primary-light hover:text-primary hover:border-primary/30",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-primary-light hover:text-primary",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-primary text-primary-foreground shadow-elevated hover:shadow-card hover:bg-primary/95 px-8 py-6 text-base rounded-2xl font-semibold",
        soft: "bg-primary-light text-primary hover:bg-primary/20 border border-primary/10",
        accent: "bg-accent text-accent-foreground hover:bg-accent/80 border border-accent-foreground/10",
      },
      size: {
